...
public class RestaurantResource {
    ...
    public ResponseEntity<Restaurant> updateRestaurant(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, restaurant.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Restaurant> partialUpdateRestaurant(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, restaurant.getId())
        );
    }
