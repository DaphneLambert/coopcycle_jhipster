...
public class CourseResource {
    ...
    public ResponseEntity<Course> updateCourse(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, course.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Course> partialUpdateCourse(
        ...
        Optional<Course> result = courseRepository
            ...
            .map(
                existingCourse -> {
                    if (course.getTimeRequired() != null) {
                        existingCourse.setTimeRequired(course.getTimeRequired());
                    }
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, course.getId()));
    }
