...
public class CooperativeResource {
    ...
    public ResponseEntity<Cooperative> updateCooperative(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, cooperative.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Cooperative> partialUpdateCooperative(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, cooperative.getId())
        );
    }
    ...
    public ResponseEntity<Void> deleteCooperative(@PathVariable String id) {
