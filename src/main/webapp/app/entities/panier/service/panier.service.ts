...
export class PanierService {
  ...
  update(panier: IPanier): Observable<EntityResponseType> {
    return this.http.put<IPanier>(`${this.resourceUrl}/${getPanierIdentifier(panier) as string}`, panier, { observe: 'response' });
  }

  partialUpdate(panier: IPanier): Observable<EntityResponseType> {
    return this.http.patch<IPanier>(`${this.resourceUrl}/${getPanierIdentifier(panier) as string}`, panier, { observe: 'response' });
  }
