...
export class CompteService {
  ...
  update(compte: ICompte): Observable<EntityResponseType> {
    return this.http.put<ICompte>(`${this.resourceUrl}/${getCompteIdentifier(compte) as string}`, compte, { observe: 'response' });
  }

  partialUpdate(compte: ICompte): Observable<EntityResponseType> {
    return this.http.patch<ICompte>(`${this.resourceUrl}/${getCompteIdentifier(compte) as string}`, compte, { observe: 'response' });
  }
